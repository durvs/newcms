...
export const BLOCK_DEFINITIONS: BlockDefinition[] = [
	...
	},
	{
		...
		icon: '≡',
		category: 'text',
		defaultAttrs: { items: [''], ordered: false },
	},
	{
		type: 'quote',
		label: 'Quote',
	...
	},
	{
		...
		icon: '▢',
		category: 'design',
		defaultAttrs: { text: 'Click me', url: '' },
	},
