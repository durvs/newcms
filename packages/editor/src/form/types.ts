...
export type FormFieldType =
	| 'text' | 'email' | 'textarea' | 'url' | 'tel' | 'number'
	| 'date' | 'time' | 'select' | 'radio' | 'checkbox'
	| 'toggle' | 'file' | 'acceptance' | 'hidden' | 'html' | 'password';
...
export const DEFAULT_FORM_CONFIG: FormConfig = {
	fields: [
		{ id: 'name', type: 'text', label: 'Name', placeholder: 'Your name', required: true, width: 100 },
		{ id: 'email', type: 'email', label: 'Email', placeholder: 'your@email.com', required: true, width: 100 },
		{ id: 'message', type: 'textarea', label: 'Message', placeholder: 'Your message...', required: false, width: 100 },
	],
