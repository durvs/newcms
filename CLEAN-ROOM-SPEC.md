...
*Este documento mapeia o comportamento funcional completo do sistema. Qualquer implementação que atenda fielmente a estas especificações será funcionalmente compatível com o sistema original, independentemente da tecnologia utilizada.*
