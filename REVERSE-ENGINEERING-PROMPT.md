...
- Funções de tradução: __, _e, _x, _n, _nx com escape.
...
*Este prompt, combinado com `CLEAN-ROOM-SPEC.md`, contém toda a informação necessária para reimplementar o ecossistema completo. Comece pela Fase 1: monorepo setup + HookEngine + banco + cache.*
